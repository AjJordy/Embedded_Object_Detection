...
import sys
sys.path.insert(0, 'D:\\Humanoid\\cocoapi')
from PythonAPI.main.model.squeezeDet import  SqueezeDet
from PythonAPI.main.model.dataGenerator import generator_from_data_path, read_image_and_gt
from PythonAPI.main.model.modelLoading import load_only_possible_weights
from PythonAPI.main.model.multi_gpu_model_checkpoint import  ModelCheckpointMultiGPU
from PythonAPI.main.config.create_config import load_dict
...
# STEPS = 20
# img_dir = '..\\PythonAPI\\train2017'
base_dir = 'D:\\Humanoid\\cocoapi'
img_file = base_dir + '\\PythonAPI\\images.txt'
gt_dir = base_dir + '\\PythonAPI\\annotations\\instances_train2017.json'
log_dir_name = '.\\log'
init_file = "none" # "imagenet.h5"
EPOCHS = 10
OPTIMIZER = "default"
...
CONFIG = base_dir + "\\PythonAPI\\main\\config\\squeeze.config"
