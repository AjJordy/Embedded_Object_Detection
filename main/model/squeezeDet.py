...
import sys
sys.path.insert(0, 'D:\\Humanoid\\cocoapi\\PythonAPI\\main')
import utils.utils as utils

from keras.models import Model
from keras.layers import Input, MaxPool2D, Conv2D, Dropout, concatenate, Reshape, Lambda, AveragePooling2D, Flatten
...
class SqueezeDet():
    ...
    def _create_model(self):
        ...
        preds=Conv2D(name='conv12', filters=num_output, kernel_size=(3, 3),
    ...
    def loss(self, y_true, y_pred):
        ...
        conf_loss = K.mean(
            K.sum(
                K.square((ious - pred_conf)) * (input_mask * mc.LOSS_COEF_CONF_POS / num_objects
    ...
    def bbox_loss(self, y_true, y_pred):
        ...
        y_pred = K.reshape(y_pred, (mc.BATCH_SIZE,
                                    mc.N_ANCHORS_HEIGHT,
